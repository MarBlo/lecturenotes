---
title: "![](logoII.png){width=2in}"
author:
  name: Martin Bloemacher
  affiliation: BASF SE | EDM
...
output:
  ...
  pdf_document:
    ...
    pandoc_args: --template=mytemplate.tex
...
knitr::include_graphics(here('inst', 'rmarkdown',
                             'templates', 'template-name',
                             'skeleton', 'logoII.png'))

#file.copy(file.path(R.home("doc"), "html", "logoII.png"), '.')
